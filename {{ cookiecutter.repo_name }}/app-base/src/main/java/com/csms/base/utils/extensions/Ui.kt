...
import com.csms.chaperone.utils.extensions.ifNull
...
fun <T> Activity.showErrorToast(it: com.csms.base.domain.models.Resource<T>) {
    it.message?.apply {
        showToast(this)
        return
    }
...
fun <T> Fragment.showErrorToast(it: com.csms.base.domain.models.Resource<T>) {
    it.message?.apply {
        showToast(this)
        return
    }
...
fun <T> Context.showErrorToast(it: com.csms.base.domain.models.Resource<T>) {
    it.message?.apply {
        showToast(this)
        return
    }
